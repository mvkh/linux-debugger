...
sdb::breakpoint_site::breakpoint_site(process& proc, virt_addr address, bool is_hardware = false, bool is_internal = false):
...
void sdb::breakpoint_site::disable()
{
    ...
    if (is_hardware_)
    {
        ...
        auto restored_data = ((data & ~0xff) | static_cast<uint8_t>(saved_data_));
